...
export const coinSource = {
  ...
  hyper_all: {
    ...
    es: 'Hyperliquid Todos',
  },
  hyper_main: {
    zh: 'Hyperliquid 主流市场',
    en: 'Hyperliquid Main Markets',
    es: 'Hyperliquid Principales',
  },
  staticCoins: {
    zh: '自定义币种',
    en: 'Custom Coins',
  ...
  useHyperAll: {
    zh: '启用 Hyperliquid 全部 USDC 合约',
    en: 'Enable all Hyperliquid USDC perps',
    es: 'Habilitar todos Hyperliquid USDC',
  },
  useHyperMain: {
    zh: '启用 Hyperliquid 成交额主流市场',
    en: 'Enable top Hyperliquid markets by volume',
    es: 'Habilitar principales por volumen',
  },
  ...
  hyper_allDesc: {
    zh: '一键扫描 Hyperliquid 所有 USDC 美股/大宗/加密合约',
    en: 'Scan every Hyperliquid USDC equity, commodity and crypto perp',
    es: 'Escanear todos los perps USDC',
  },
  hyper_mainDesc: {
    zh: '优先扫描成交额最高的 Hyperliquid USDC 市场',
    en: 'Scan the highest-volume Hyperliquid USDC markets first',
    es: 'Escanear mercados USDC principales',
  },
  hyperAssetsNote: {
    zh: '覆盖 TSLA、NVDA、AAPL、GOLD、SILVER、BTC、ETH 等 Hyperliquid 上线的 USDC 合约；资产列表由 Hyperliquid 实时拉取。',
    en: 'Covers listed Hyperliquid USDC perps such as TSLA, NVDA, AAPL, GOLD, SILVER, BTC and ETH; the tradable universe is pulled live from Hyperliquid.',
    es: 'Cubre perps USDC listados en Hyperliquid.',
  },
