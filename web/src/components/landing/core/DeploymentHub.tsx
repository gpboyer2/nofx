        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-nofx-text-muted text-lg leading-relaxed font-light">
              在笔记本或服务器上一条命令即可安装全部。打开它打印的地址、创建账号，引导流程约
              5 分钟内帮你完成第一笔 AI 交易——约 13 美元即可开始。
            </p>
              ...
              {[
                {
                  icon: Command,
                  label: '一键安装',
                  desc: 'Docker 自动处理所有依赖',
                },
                {
                  icon: Shield,
                  label: '密钥留本地',
                  desc: '运行在您的机器上，密钥本地加密',
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="flex gap-4 items-start p-4 rounded bg-nofx-bg-lighter border border-[rgba(26,24,19,0.14)] hover:border-nofx-gold/30 transition-colors group"
                >
                  ...
                  <div>
                    <h4 className="text-nofx-text font-bold font-mono text-sm mb-1">
                      {item.label}
                    </h4>
