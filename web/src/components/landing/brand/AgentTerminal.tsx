            ...
            <div className="relative bg-nofx-bg-lighter rounded-2xl overflow-hidden shadow-lg border border-[rgba(26,24,19,0.14)]">
                ...
                <div className="flex items-center justify-between px-4 py-2.5 bg-nofx-bg-deeper border-b border-[rgba(26,24,19,0.14)]">
                    ...
                    <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-2">
                        <span className="text-nofx-text-muted text-xs font-mono">NOFX 交易终端</span>
                    </div>
                    {/* Live indicator */}
                    <div className="flex items-center gap-1.5 px-2 py-0.5 rounded bg-nofx-success/10 border border-nofx-success/20">
                        ...
                        <span className="text-nofx-success text-[10px] font-mono uppercase tracking-wider">实时</span>
                    </div>
                </div>
                ...
                <div className="p-4 border-b border-[rgba(26,24,19,0.14)]">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-nofx-text-muted text-xs font-mono uppercase tracking-wider">投资组合盈亏</span>
                ...
                <div className="grid grid-cols-3 divide-x divide-[rgba(26,24,19,0.14)] border-b border-[rgba(26,24,19,0.14)]">
                    <div className="p-3 text-center">
                        <div className="text-nofx-text-muted text-[10px] font-mono uppercase tracking-wider mb-1">持仓量</div>
                        <div className="text-nofx-text font-bold font-mono">$847M</div>
                        <div className="text-nofx-success text-[10px] font-mono">↑ 2.1%</div>
                    </div>
                    <div className="p-3 text-center">
                        <div className="text-nofx-text-muted text-[10px] font-mono uppercase tracking-wider mb-1">净流入</div>
                        <div className="text-nofx-success font-bold font-mono">+$124M</div>
                        <div className="text-nofx-text-muted text-[10px] font-mono">24小时流入</div>
                    </div>
                    <div className="p-3 text-center">
                        <div className="text-nofx-text-muted text-[10px] font-mono uppercase tracking-wider mb-1">多空比</div>
                ...
                <div className="p-4 border-b border-[rgba(26,24,19,0.14)]">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-nofx-text text-xs font-mono uppercase tracking-wider">委托簿</span>
                        <span className="text-nofx-text-muted text-[10px] font-mono">价差: <span className="text-nofx-gold">0.02%</span></span>
                    </div>
                ...
                <div className="p-4">
                    <div className="flex items-center justify-between mb-3">
                        <span className="text-nofx-text text-xs font-mono uppercase tracking-wider">持仓</span>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2 text-[10px]">
                                            <span className="text-nofx-success bg-nofx-success/10 px-1.5 py-0.5 rounded font-mono">做多</span>
