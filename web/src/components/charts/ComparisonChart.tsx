    ...
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        >
          <BarChart3
            className="w-10 h-10"
            style={{ color: '#E0483B', opacity: 0.6 }}
          />
        </div>
          ...
          {traderStats.slice(0, 3).map((trader, idx) => (
            ...
            >
              ...
              <span
                ...
                style={{
                  color: trader.currentPnl >= 0 ? '#2E8B57' : '#D6433A',
                }}
              >
                {trader.currentPnl >= 0 ? '+' : ''}
      ...
      <div className="grid grid-cols-4 gap-2">
        <div
          ...
          style={{
            ...
            border: '1px solid rgba(224, 72, 59, 0.1)',
          }}
        >
          <div
        ...
        >
          ...
          <div
            ...
            style={{
              color: (leader?.currentPnl || 0) >= 0 ? '#2E8B57' : '#D6433A',
            }}
          >
        ...
        <div
          className="p-3 rounded-lg text-center"
          style={{ background: 'rgba(26, 24, 19, 0.04)' }}
        >
          <div
            className="text-[10px] uppercase tracking-wider mb-1"
            style={{ color: '#8A8478' }}
