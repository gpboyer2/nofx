        ...
        <React.Fragment key={index}>
          ...
          {index < labels.length - 1 && (
            <div
              ...
              style={{
                background: index < currentStep ? '#2E8B57' : '#E8E2D5',
              }}
            />
          )}
        </React.Fragment>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (
        ...
        toast.error(
          language === 'zh'
            ? '使用钱包授权流程连接 Hyperliquid。'
            : 'Use the wallet authorization flow to connect Hyperliquid.'
        )
        return
                ...
                <>
                    ...
                    >
                      ...
                      {showBinanceGuide && (
                        <div
                          ...
                          style={{
                            borderTop: '1px solid rgba(224, 72, 59, 0.2)',
                            color: '#1A1813',
                          }}
                        >
                          <a
                  ...
                  {editingExchangeId && selectedExchange && (
                    ...
                    >
                      ...
                      Secret{' '}
                      {language === 'zh'
                        ? selectedExchange.has_secret_key
                          ? '已配置'
                          : '未配置'
                        : selectedExchange.has_secret_key
                          ? 'configured'
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        >
                          {language === 'zh'
                            ? 'Hyperliquid 需要钱包授权'
                            : 'Hyperliquid requires wallet authorization'}
                        </div>
                        <div
                  ...
                  {selectedExchange?.hyperliquidWalletAddr && (
                    <HyperliquidFundsPanel
                      ...
                      unifiedAccount={
                        selectedExchange.hyperliquidUnifiedAccount ?? true
                      }
                    />
                  )}
                </div>
